...
<body>
    ...
    <div>
        ...
        <br />
        <br />
        <asp:Label ID="lblMessage1" runat="server" style="z-index: 1; left: 554px; top: 174px; position: absolute; width: 475px" Text="Enter &quot;Teacher&quot; if you are a teacher and if you are a HR enter &quot;HR&quot; "></asp:Label>
        <br />
        ...
        <asp:Label ID="lblType" runat="server" style="z-index: 1; left: 25px; top: 171px; position: absolute; width: 65px" Text="Enter your Role"></asp:Label>
        <br />
